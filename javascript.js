class Escena extends Phaser.Scene{
    ...
    create(){
        ...
        this.bola.setBounce(1);
        this.bola.setCollideWorldBounds(true); // ← CORRECTO
        ...
        this.musica = this.sound.add('musicaFondo', {
            loop: true,
            volume: 0.5 // Puedes ajustar el volumen aquí
        });
        this.musica.play();
    ...
    update(){
        ...
        //Movimientos para el primer jugador
        if(this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.W).isDown || this.mano1.getData('direccionVertical') === 1){
            this.mano1.y = this.mano1.y - 5;
        } else if(this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.S).isDown || this.mano1.getData('direccionVertical') === -1){
            this.mano1.y = this.mano1.y + 5;
        }
    ...
    pintarMarcador(){
        ...
        this.nombre = this.add.text(150, 550, 'Richard Mauricio Rodas Carhuas', {
            fontFamily: 'fantasy',
            fontSize: '50px',
            color: '#ffffff',
            stroke: '#000000',            // Color del borde (negro)
